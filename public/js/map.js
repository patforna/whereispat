...
var bicycleMarkerImage = new google.maps.MarkerImage('/images/bicycle_50.png', null,null,null,null);
 ...
 var mapOptions = { center: patsCurrentLocation, zoom: 7, mapTypeId: google.maps.MapTypeId.TERRAIN };
...
$.each(route.places, function() { 
	...
	var pathMarker = new google.maps.Marker({position:new google.maps.LatLng(this.latitude, this.longitude), map: map, icon: twitterMarkerImage});
});
